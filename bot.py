...
ADMIN_GROUP_ID = -1003342853736  # Anonim savollar shu guruhga keladi

bot = telebot.TeleBot(TOKEN)
user_state = {}
all_users = set()

# Anime watchlist: {user_id: {"korgan": [...], "kormoqchi": [...]}}
watchlist = {}

# Anonim savol-javob uchun: {guruhdagi_xabar_id: foydalanuvchi_id}
anon_messages = {}
...
# Guruhda "Reply" qilingan xabarlarni ushlab, foydalanuvchiga yuborish
...
def handle_admin_reply(message):
    ...
    if replied_id in anon_messages:
        ...
        try:
            ...
            bot.reply_to(message, "⚠️ Javobni yuborib bo'lmadi (foydalanuvchi botni bloklagan bo'lishi mumkin).")
